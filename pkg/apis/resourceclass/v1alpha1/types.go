...
type ResourceClass struct {
	...
	// Spec defines resources' details
	Spec ResourceClassSpec `json:"spec"`

	// Most recently observed status of the ResourceClass.
...
type ResourceClassSpec struct {
	// ResourceName is advertised by device plugin.
	ResourceName string `json:"resourceName"`
	// DevicesIDs is advertised by device plugin, we cached here.
	DevicesIDs []string `json:"deviceIDs"`
	// A list of resource selector requirements.
	// The requirements are ANDed.
	MatchExpressions []ResourceSelectorRequirement
	// An array of available nodes for this resource class.
...
// ResourceClassStatus represents information about the status of a resource-class.
type ResourceClassStatus struct {
	// Default is true, If false then this resource can't be required.
