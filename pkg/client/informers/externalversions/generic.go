...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=Resourceclass, Version=V1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("resourceclasses"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Resourceclass().V1alpha1().ResourceClasses().Informer()}, nil
