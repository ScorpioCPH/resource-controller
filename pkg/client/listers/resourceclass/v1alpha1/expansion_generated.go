...
// ResourceClassNamespaceListerExpansion allows custom methods to be added to
// ResourceClassNamespaceLister.
type ResourceClassNamespaceListerExpansion interface{}
